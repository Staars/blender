...
void MetalMemoryManager::DeviceBuffer::add_allocation(Allocation &allocation)
{
  allocations.push_back(&allocation);
}

void MetalMemoryManager::DeviceBuffer::update_device_memory(MetalDevice *device)
{
...
void MetalMemoryManager::DeviceBuffer::free(MetalDevice *)
{
  buffer->free();
}

MetalMemoryManager::DeviceBuffer *MetalMemoryManager::smallest_device_buffer()
{
...
MetalMemoryManager::MetalMemoryManager(MetalDevice *device) : device(device), need_update(false)
{
  foreach (DeviceBuffer &device_buffer, device_buffers) {
...
void MetalMemoryManager::alloc(const char *name, device_memory &mem)
{
...
bool MetalMemoryManager::free(device_memory &mem)
{
...
MetalMemoryManager::BufferDescriptor MetalMemoryManager::get_descriptor(string name)
{
...
void MetalMemoryManager::update_device_memory()
{
  if (!need_update) {
    return;
  }
...
void MetalMemoryManager::set_kernel_arg_buffers(cl_kernel kernel, cl_uint *narg)
{
  update_device_memory();
