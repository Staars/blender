...
ccl_device_noinline void svm_node_mapping(METAL_ASQ_DEVICE const KernelGlobals *kg,
...
ccl_device_noinline void svm_node_texture_mapping(METAL_ASQ_DEVICE const KernelGlobals *kg,
                                         METAL_ASQ_DEVICE ShaderData *sd,
                                         METAL_ASQ_THREAD float *stack,
                                         uint vec_offset,
                                         uint out_offset,
...
ccl_device_noinline void svm_node_min_max(METAL_ASQ_DEVICE const KernelGlobals *kg,
                                 METAL_ASQ_DEVICE ShaderData *sd,
                                 METAL_ASQ_THREAD float *stack,
                                 uint vec_offset,
                                 uint out_offset,
